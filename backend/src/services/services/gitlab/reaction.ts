      ...
      properties: {
        note: {
          ...
          properties: {
            ...
            created_at: { type: 'string', description: 'Creation timestamp' },
            system: { type: 'boolean', description: 'Whether this is a system note' },
            noteable_type: { type: 'string', description: 'Type of object the note is on' },
            noteable_id: { type: 'number', description: 'ID of the object the note is on' },
          },
        },
      },
      required: ['note'],
