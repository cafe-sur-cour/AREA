...
export class SlackOAuth {
  ...
  getAuthorizationUrl(state: string): string {
    const params = new URLSearchParams({
      ...
      scope:
        'channels:read,channels:history,chat:write,users:read,groups:read,groups:history,im:read,im:write,im:history,mpim:read,reactions:read,reactions:write,pins:write',
      user_scope:
        'channels:read,channels:history,chat:write,groups:read,groups:history,im:read,im:write,im:history,mpim:read,reactions:read,reactions:write,pins:write',
