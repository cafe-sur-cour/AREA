  ...
  group('ReactionServicesScreen', () {
    ...
    Widget createTestWidget() {
      return MultiProvider(
        ...
        child: MaterialApp(
          ...
          home: const ReactionServicesScreen(),
        ),
      );
    }
    ...
    testWidgets('loads and displays services successfully', (WidgetTester tester) async {
      ...
      final mockClient = MockClient((request) async {
        if (request.url.toString().contains('api/services/reactions')) {
    ...
    testWidgets('shows error state when backend address is null', (WidgetTester tester) async {
      ...
      final context = tester.element(find.byType(ReactionServicesScreen));
    ...
    testWidgets('navigates to ServiceReactionsScreen when service is tapped', (
      WidgetTester tester,
    ) async {
      mocktail.when(() => mockBackendNotifier.backendAddress).thenReturn('http://test.com/');
    ...
    testWidgets('renders app bar with correct title', (WidgetTester tester) async {
      ...
      final context = tester.element(find.byType(ReactionServicesScreen));
      final localizations = AppLocalizations.of(context)!;
      expect(find.text(localizations.reaction_services), findsOneWidget);
    });
    ...
    testWidgets('shows correct message for no services with reactions', (
      WidgetTester tester,
    ) async {
      mocktail.when(() => mockBackendNotifier.backendAddress).thenReturn('http://test.com/');
      ...
      final context = tester.element(find.byType(ReactionServicesScreen));
      final localizations = AppLocalizations.of(context)!;
      expect(find.text(localizations.no_services_with_reactions), findsOneWidget);
    });
  });
}
