        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-lg sm:text-xl text-muted-foreground mb-10 max-w-2xl mx-auto text-pretty">
              Connect your favorite apps and services to create powerful automations. Save time and focus on what
              matters most.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12">
            <div className="text-center md:text-left">
              <div className="text-4xl font-heading font-bold text-foreground mb-2">10M+</div>
            ...
            <div className="text-center md:text-left">
              <div className="text-4xl font-heading font-bold text-foreground mb-2">2M+</div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-card border border-border rounded-lg p-8 text-center">
              ...
              <h3 className="text-xl font-heading font-semibold text-foreground mb-3">Choose a trigger</h3>
              <p className="text-muted-foreground">Select an app and event that starts your automation</p>
            </div>
            ...
            <div className="bg-card border border-border rounded-lg p-8 text-center">
              ...
              <h3 className="text-xl font-heading font-semibold text-foreground mb-3">Add an action</h3>
              <p className="text-muted-foreground">Choose what happens when your trigger fires</p>
            </div>
            ...
            <div className="bg-card border border-border rounded-lg p-8 text-center">
              ...
              <h3 className="text-xl font-heading font-semibold text-foreground mb-3">Activate & relax</h3>
              <p className="text-muted-foreground">Your automation runs automatically in the background</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="px-4 sm:px-6 lg:px-8 py-24">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">Get inspired by what others are building</p>
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            <div className="text-center lg:text-left">
              ...
              <h3 className="text-xl font-heading font-semibold text-foreground mb-3">Lightning fast</h3>
            ...
            <div className="text-center lg:text-left">
              ...
              <h3 className="text-xl font-heading font-semibold text-foreground mb-3">Save time</h3>
              <p className="text-muted-foreground">
            ...
            <div className="text-center lg:text-left">
              ...
              <h3 className="text-xl font-heading font-semibold text-foreground mb-3">Secure & reliable</h3>
              <p className="text-muted-foreground">
