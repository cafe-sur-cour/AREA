...
export default function DashboardPage() {
  ...
  const toggleAutomationStatus = async (id: number, currentStatus: string) => {
    ...
    setAutomations(prev => 
      prev.map(automation => 
        automation.id === id 
          ? { ...automation, status: newStatus as 'active' | 'inactive' | 'error' }
          : automation
      )
    );
  };
  ...
  const getTriggerIcon = (trigger: string) => {
    ...
    if (trigger.includes('Discord') || trigger.includes('Twitter')) return <MessageSquare className="h-4 w-4" />;
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
              ...
              >
                ...
                <div className="text-left">
                  ...
                  <div className="text-xs text-muted-foreground">Link new platforms</div>
                </div>
              </Button>
              ...
              >
                ...
                <div className="text-left">
                  ...
                  <div className="text-xs text-muted-foreground">Pre-made automations</div>
                </div>
              </Button>
